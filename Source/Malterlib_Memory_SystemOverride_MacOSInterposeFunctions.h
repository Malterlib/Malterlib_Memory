...
DMibMemoryInterpose4(int, __ulock_wait, uint32_t _0, void *_1, uint64_t _2, uint32_t _3)
DMibMemoryInterpose5(int, __ulock_wait2, uint32_t _0, void *_1, uint64_t _2, uint64_t _3, uint64_t _4)
DMibMemoryInterpose4(int, os_sync_wait_on_address, void *_0, uint64_t _1, size_t _2, uint32_t _3)
DMibMemoryInterpose6(int, os_sync_wait_on_address_with_timeout, void *_0, uint64_t _1, size_t _2, uint32_t _3, uint32_t _4, uint64_t _5)
...
DMibMemoryInterpose3(int, poll, struct pollfd *_0, nfds_t _1, int _2)
DMibMemoryInterpose2(int, nanosleep, const struct timespec *_0, struct timespec *_1)
