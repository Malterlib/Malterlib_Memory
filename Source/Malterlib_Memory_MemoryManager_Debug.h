...
#		define DMibErrorMemoryManagerDebug(_Description) DMibImpError(NMib::NMem::CExceptionMemoryManagerDebug, _Description)
...
#		endif
		...
		struct TCMemoryManagerDebugParams : public t_CParams
		{
			...
			struct CNotifier
			{
				...
				struct CArena
				{
					...
					NContainer::TCMapWithPool<uint8 *, CAllocInfo, NMib::CSort_Default, typename t_CParams::CAllocator, (2*1024*1024) / sizeof(CAllocInfo), NMib::NMem::CPoolType_Growing> m_Allocations;
				};
		...
		private:
			...
			TCPool<zbool, 8, NThread::CMutual, NMem::CPoolType_Freeable, typename t_CParams::CAllocator> m_ReportingLeaksPool;
