...
namespace NMib
{
	namespace NMem
	{
		enum
		{
			EMemoryManagerCrossModule_Version = 0x102
		};
		...
		struct CCrossModuleImplementationDefaults
		{
			...
			static void * fs_AllocDebug(CMemoryManagerCrossModule *_pModule, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			static void * fs_AllocAlignedDebug(CMemoryManagerCrossModule *_pModule, mint &_Size, mint _Align, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			static void * fs_ReallocDebug(CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			static void * fs_ResizeDebug(CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			...
			static void * fs_NonTracked_Realloc(CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size);
			static void * fs_NonTracked_Resize(CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size);
			static void fs_NonTracked_Free(CMemoryManagerCrossModule *_pModule, void *_pBlock);
			static void * fs_NonTracked_AllocDebug(CMemoryManagerCrossModule *_pModule, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			static void * fs_NonTracked_ReallocDebug(CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			static void * fs_NonTracked_ResizeDebug(CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			static void * fs_NonTracked_AllocAlignedDebug(CMemoryManagerCrossModule *_pModule, mint &_Size, mint _Alignment, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
		...
		struct CCrossModuleImplementation : public CCrossModuleImplementationDefaults
		{
			...
			static void * fs_Realloc(CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size);
			static void * fs_Resize(CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size);
			static void fs_Free(CMemoryManagerCrossModule *_pModule, void *_pMemory);
		...
		struct CMemoryManagerCrossModule
		{
			...
			void * (* m_fAllocDebug)(CMemoryManagerCrossModule *_pModule, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			void * (* m_fAllocAlignedDebug)(CMemoryManagerCrossModule *_pModule, mint &_Size, mint _Align, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			void * (* m_fReallocDebug)(CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			void * (* m_fResizeDebug)(CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			void * (* m_fRealloc)(CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size);
			void * (* m_fResize)(CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size);
			void (* m_fFree)(CMemoryManagerCrossModule *_pModule, void *_pMemory);
			...
			void * (* m_fNonTracked_Realloc)(CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size);
			void * (* m_fNonTracked_Resize)(CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size);
			void (* m_fNonTracked_Free)(CMemoryManagerCrossModule *_pModule, void *_pBlock);
			void * (* m_fNonTracked_AllocDebug)(CMemoryManagerCrossModule *_pModule, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			void * (* m_fNonTracked_AllocAlignedDebug)(CMemoryManagerCrossModule *_pModule, mint &_Size, mint _Alignment, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			void * (* m_fNonTracked_ReallocDebug)(CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
			void * (* m_fNonTracked_ResizeDebug)(CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size, const ch8 *_pFile, aint _Line, EHeapDebugFlag _Flags);
