...
namespace NMib
{
	...
	void CSystem::fp_CreateNonTrackedMemoryManager()
	{
		...
		if (g_pLocalCrossModuleInterface)
		{
			...
			{
				NMemory::g_CrossModule.m_fReportingLeaks = [](CMemoryManagerCrossModule *_pModule) -> bool
					{
						return false;
					}
				;
			...
			{
				NMemory::g_CrossModule.m_fAlloc = [](CMemoryManagerCrossModule *_pModule, mint _Size) -> void *
					{
						return NMemory::g_CrossModule.m_fAllocWithSize(&g_CrossModule, _Size);
					}
				;
				NMemory::g_CrossModule.m_fAllocInitZero = [](CMemoryManagerCrossModule *_pModule, mint _Size) -> void *
					{
						return NMemory::g_CrossModule.m_fAllocInitZeroWithSize(&g_CrossModule, _Size);
					}
				;
				NMemory::g_CrossModule.m_fAllocAligned = [](CMemoryManagerCrossModule *_pModule, mint _Size, mint _Align) -> void *
					{
						return NMemory::g_CrossModule.m_fAllocAlignedWithSize(&g_CrossModule, _Size, _Align);
					}
				;

				NMemory::g_CrossModule.m_fNonTracked_Alloc = [](CMemoryManagerCrossModule *_pModule, mint _Size) -> void *
					{
						return NMemory::g_CrossModule.m_fNonTracked_AllocWithSize(&g_CrossModule, _Size);
					}
				;
				NMemory::g_CrossModule.m_fNonTracked_AllocAligned = [](CMemoryManagerCrossModule *_pModule, mint _Size, mint _Alignment) -> void *
					{
				...
				;
				NMemory::g_CrossModule.m_fRealloc = [](CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size, mint _OldSize, EAllocationFlag _AllocFlags) -> void *
					{
						return NMemory::g_CrossModule.m_fReallocNoOld(&g_CrossModule, _pMemory, _Size);
					}
				;
				NMemory::g_CrossModule.m_fResize = [](CMemoryManagerCrossModule *_pModule, void *_pMemory, mint &_Size, mint _OldSize, EAllocationFlag _AllocFlags) -> void *
					{
						return NMemory::g_CrossModule.m_fResizeNoOld(&g_CrossModule, _pMemory, _Size);
					}
				;

				NMemory::g_CrossModule.m_fNonTracked_Realloc = [](CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size, mint _OldSize, EAllocationFlag _AllocFlags) -> void *
					{
						return NMemory::g_CrossModule.m_fNonTracked_ReallocNoOld(&g_CrossModule, _pMem, _Size);
					}
				;

				NMemory::g_CrossModule.m_fNonTracked_Resize = [](CMemoryManagerCrossModule *_pModule, void *_pMem, mint &_Size, mint _OldSize, EAllocationFlag _AllocFlags) -> void *
					{
				...
				NMemory::g_CrossModule.m_fFree = [](CMemoryManagerCrossModule *_pModule, void *_pMemory, mint _Size)
					{
						return NMemory::g_CrossModule.m_fFreeNoSize(&g_CrossModule, _pMemory);
					}
				;

				NMemory::g_CrossModule.m_fNonTracked_Free = [](CMemoryManagerCrossModule *_pModule, void *_pMemory, mint _Size)
					{
