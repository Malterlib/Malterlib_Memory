...
#			endif
	...
	// Kernel waits must return checked-out arenas so idle threads do not prevent garbage collection.
	// os_sync needs separate hooks because shared-cache ulock calls bypass interposition.
